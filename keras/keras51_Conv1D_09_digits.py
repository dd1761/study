...
from tensorflow.keras.layers import Dense,Input, Dropout, Conv2D, Flatten, MaxPooling2D, LSTM, Conv1D
...
print(x_train.shape, x_test.shape)  #(1347, 64) (450, 64)


x_train = x_train.reshape(1347, 8, 8)
...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1,
                    ...
                    #   filepath = path +'MCP/keras30_ModelCheckPoint3.hdf5'
                      filepath = filepath + 'k51_09_' + date + '_' + filename
                      )
