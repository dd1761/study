...
model.add(Conv2D(filters=118, kernel_size=(3,3)))    # (30, 30, 64)  
model.add(MaxPooling2D((2, 2)))
model.add(Conv2D(filters=108, kernel_size=(2,2)))    # (28, 28, 32)  flatten -> 25088
model.add(Flatten())
model.add(Dense(98, activation='relu'))             #input_shape = (40000)
