...
x_train = x_train.reshape(15480, 4, 2)
x_test = x_test.reshape(5160, 4, 2)


#2. 모델구성(순차형)
model = Sequential()
# model.add(LSTM(256, input_shape=(4,2), activation='relu'))
model.add(Conv1D(64, 2, input_shape=(4,2), activation='relu'))
...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1,
                    ...
                    #   filepath = path +'MCP/keras30_ModelCheckPoint3.hdf5'
                      filepath = filepath + 'k51_02_' + date + '_' + filename
                      )
...
'''
mse :  0.2822600305080414
R2스코어  :  0.7856362271409311
