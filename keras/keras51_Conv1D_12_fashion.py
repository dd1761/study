...
from tensorflow.keras.layers import Conv2D, Dense, Flatten,  MaxPooling2D, Dropout, Input, LSTM, Conv1D
...
#2. 모델구성
model = Sequential()
model.add(Conv1D(128, activation='relu', input_shape=(28 ,28)))   # (27, 27, 128) # 28 * 28 = 784
...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1,
                    ...
                    #   filepath = path +'MCP/keras30_ModelCheckPoint3.hdf5'
                      filepath = filepath + 'k51_12_' + date + '_' + filename
                      )
