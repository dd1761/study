...
#2. 모델구성
model = Sequential()
model.add(Dense(128, activation='relu', input_shape=(784, )))   # (27, 27, 128) # 28 * 28 = 784
...
model.add(Dense(8, activation='relu'))             # (60000, 32)                                                                                                   
...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1,
                    ...
                    #   filepath = path +'MCP/keras30_ModelCheckPoint3.hdf5'
                      filepath = filepath + 'k36_01_' + date + '_' + filename
                      )
