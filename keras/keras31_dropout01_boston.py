...
model.add(Dropout(0.5))                                 # Dropout을 사용하면 레이어의 50프로를 줄인다.
model.add(Dense(40, activation='sigmoid'))
model.add(Dropout(0.3))                                 # Dropout을 사용하면 레이어의 30프로를 줄인다.
model.add(Dense(30, activation='relu'))
model.add(Dropout(0.2))                                 # Dropout을 사용하면 레이어의 20프로를 줄인다.
