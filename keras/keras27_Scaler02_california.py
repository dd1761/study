...
model.fit(x_train, y_train, epochs=300, batch_size=20, validation_split=0.25, callbacks=[earlyStopping] , verbose=1) 
...
minmax 변환
train_size=0.7
RMSE :  2.3866878241121334
R2 :  -3.3078921373034804

StandardScaler 변환
RMSE :  1.2743778061675497
R2 :  -0.22820252118617002
'''
