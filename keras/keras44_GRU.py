...
model.add(GRU(units=10, input_shape=(3,1)))    # model.add(SimpleRNN(units=64, input_shape=(3,1), activation='relu'))
...
#LSTM
# lstm (10 * (10 + 1 + 1) * 4) = 480    4 * simpleRNN = LSTM
# GRU   (10 * (10 + 1 + 1) * 3) = 360    3 * simpleRNN = GRU
